...
import { displayArtist, retainKnownTrackIds, sortTracks, type TrackSortField } from './tracks'
...
const emptyRecentTrackItems: RecentTrackItem[] = []
...
function App() {
  ...
  const recentTrackItems = recentTracksQuery.data ?? emptyRecentTrackItems
